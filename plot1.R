# plot1.R - To plot Gloabl Active Power Histogram
...
hist(hpcs$Global_active_power,xlab="Global Active Power (kiloWatts)",ylab="Frequency", 
      col="red", main="Global Active Power")
dev.copy(png,"./plot1.png")  # Copy the plot to png file
